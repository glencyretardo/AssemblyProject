...
subjects3_2 db 10, 9, "Subjects for 3rd Year: 2nd Sem", 10, 9
            db "    The Teaching Profession         3 units", 10, 9
            db "    The Teacher & the Community, Culture, and Org Leadership        3 units", 10, 9
            db "    Research in Special Needs and Inclusive Education  2        3 units", 10, 9
            db "    Teaching Math in the Intermediate Grades        3 units", 10, 9
            db "    Edukasyong Pantahanan at Pangkabuhayan - Entrepreneurship       3 units", 10, 9
            db "    Technology for Teaching and Learning in the Elementary Grades       3 units", 10, 9
            db "    Teaching PE and Health in Elementary Grades     3 units", 10, 9
            db "    Early Childhood Inclusive Education     3 units", 10, 9, 0

subjects3_summer db 10, 9, "Subjects for 1st Year: Summer", 10, 9
            db "    Pagtuturo ng Filipino sa Elementarya - Panitikan ng Pilipinas       3 units", 10, 9
            db "    Malayuning Komunikasyon sa Wikang Filipino      3 units", 10, 9
            db "    Reading Visual Arts         3 units", 10, 9, 0
    
subjects4_1 db 10, 9, "Subjects for 4th Year: 1st Sem", 10, 9
            db "    Field Study 1           3 units", 10, 9
            db "    Field Study 2           3 units", 10, 9
            db "    General Education       5 units", 10, 9
            db "    Professional Education  5 units", 10, 9, 0

subjects4_2 db 10, 9, "Subjects for 4th Year: 2nd Sem", 10, 9
            db "    Teaching Internship         6 units", 10, 9
            db "    Career and Personality Development      3 units", 10, 9, 0
